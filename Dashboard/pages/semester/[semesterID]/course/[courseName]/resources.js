  ...
  return (
    ...
    >
      ...
      {courseResources.map((resource,index)=>(
            ...
            <Grid container spacing={0} sx={{width:'100%'}}>
              <Grid item xs={5.5}>
                 <ListItemText primary={resource.fil_name.substring(0, resource.fil_name.indexOf('.'))}/>
              </Grid>
              <Grid item xs={5.5}>
               <ListItemText primary = {resource.fil_name.substring(resource.fil_name.indexOf('.'), resource.fil_name.length)}/>
              </Grid>
              <Grid item xs={1}>
